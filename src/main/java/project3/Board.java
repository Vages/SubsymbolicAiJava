...
public class Board {
    ...
    private static Map<Heading, Map<MoveDirection, int[]>> directionToSensorAndMoveCoordinates;
    ...
    static {
        ...
        MoveDirection[] dirs = {MoveDirection.LEFT, MoveDirection.FORWARD, MoveDirection.RIGHT};
        ...
        for (int i = 0; i < 4; i++){
            ...
            for (int j = 0; j < 3; j++){
                int i1 = (i + j + 4 - 1) % 4;
                this_hs_map.put(dirs[j], relativeCoordinates[i1]);
            }
